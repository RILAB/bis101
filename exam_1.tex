...
%That hummingbirds didn't care about carotenoids
%That a few genes of large effect control adaptive variants relevant for speciation.
...
\item I make a mutant version of I207 in the lab which has pale flowers and breeds true. If I cross this mutant line with the F1 between wild-type I207 and B97, what are the phenotypic ratios I would expect to see in offspring (4 pts)?
...
\begin{figure*}[h!]
  \begin{center}
   \includegraphics[width=80mm]{images/homologs.png}
    \caption{Karyotype for chromosomes 1 and 2 of \emph{Silene} lines B97 and I207. Boxes on each chromosome represent the presence of a gene of interest (the absence of a box signifies that the gene is not present on that chromosome). The flower and leaf phenotype of each line is shown below the karyotype.} 
\label{homologs}
  \end{center}
\end{figure*}
