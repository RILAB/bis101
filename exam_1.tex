...
\item Johnston
\newpage
\item Use Figure \ref{map} (also Figure 4-13c in your book) to answer the following questions.
...
%-------------------------------------------------------------------
\begin{enumerate}
\item After the ancestral gene block undergoes 2 whole genome duplications, circle the correct response for each:
...
\item The ancestral gene block experiences transposable element mediated movement of gene B to a new chromosome.
