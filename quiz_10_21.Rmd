...
You wander into a mountain meadow, and notice that for one species of slimy sand fly, there are some individuals with blue stripes, and others with black stripes. You count the plants, and find that 3/4 of the zebras are blue-striped, and 1/4 are black-striped,. You know stripe color is monogenic and Mendelian in these flies. Can you identify which allele is dominant? If so, which is dominant and why? If not, what would you need to do to prove which is dominant?
...
In sweet peas, the pea shape phenotype is monogenic. When a round pea is crossed to a trapezoidal pea, you see 3:1 round:trapezoidal.  You sample a natural population and find that trapezoidal peas make up 36% of the population.  If peas are in HWE, 

1) What is the frequency of the "rr" genotype?
f(rr) = 36%

2. What is the frequency of the "r" allele?
